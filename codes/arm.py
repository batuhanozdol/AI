# -*- coding: utf-8 -*-
"""
Created on Thu May 30 22:44:12 2019
...
import numpy as np
import pandas as pd
veriler = pd.read_csv("C:/Users/CEM/Desktop/sepet.csv", header=None)
...
rule = apriori(t,min_support=0.01,min_confidence=0.2,min_lift=3,)
print(list(rule))
